...
tribble_dv <- tribble(
  ...
  "(Institutional Data)",
  "quintile_bottom",           "% with GPA in Bottom Quintile of Class", seq(0, 100, 20),  c(0, 100),  10,
  "(Institutional Data)",
  ...
  "(Senior Year Survey)",
  # "success_usethis_percent",      "Success:\nPercentile Ranking",       seq(0, 100, 20),    c(0, 100),  10,
  # "(Senior Year Survey)",
  # "potential_usethis_percent",    "Potetnial:\nPercentile Ranking",     seq(0, 100, 20),    c(0, 100),  10,
  # "(Senior Year Survey)",
  # "",                             "",                
  # "",
...
plots <- mapply(plot_bar_x_y_group_treat_adv, # function
       tribble_comb[,"treat_sc"] %>% t,  # arguments
       tribble_comb[,"dv"] %>% t,
       tribble_comb[,"dv_name"] %>% t, 
       tribble_comb[,"scale"] %>% t, 
       tribble_comb[,"limit"] %>% t, 
       tribble_comb[,"position"] %>% t,
       # tribble_comb[,"decimal"] %>% t, 
...
plots <- mapply(plot_bar_x_y_group_cond_adv, # function
       tribble_comb[,"cond_sc"] %>% t,  # arguments
       tribble_comb[,"dv"] %>% t,
       tribble_comb[,"dv_name"] %>% t, 
       tribble_comb[,"scale"] %>% t, 
       tribble_comb[,"limit"] %>% t, 
