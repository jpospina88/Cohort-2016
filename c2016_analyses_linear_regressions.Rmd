...
## Example
```{r}
lm(purpose_comp2 ~ treat_sc*disadv_sc, data = d) %>% summary
```
...
**NOTE:** p-values are overestimated since the function that I'm using compares each condition to all others.
...
## Example
```{r}
lm(purpose_comp2 ~ treat_sc*disadv_sc + gender + sattoact + hsrank + hsrank_no, data = d) %>% summary
