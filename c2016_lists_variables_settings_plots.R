...
tribble_dv <- tribble(
  ...
  "quintile_top",              "% with GPA in Top Quintile of Class",               seq(0, 100, 25),    c(0, 100),     5,             "(Institutional Data)",
  ...
  "major_double",              "% Double or Triple Major",                          seq(0, 100, 25),    c(0, 100),     5,             "(Institutional Data)",
  "major_grad_yes_honors",     "% Graduated with Honors",                           seq(0, 100, 25),    c(0, 100),     5,             "(Institutional Data)",
  "coterm_ever",               "% Coterm Ever",                                     seq(0, 100, 25),    c(0, 100),     5,             "(Institutional Data)",
  ...
  "major_cs_yes",              "% Graduated in Computer Science",                   seq(0, 100, 25),    c(0, 100),     5,             "(Institutional Data)",
  "probation",                 "% Ever on Probation",                               seq(0, 100, 25),    c(0, 100),     10,            "(GPA < 2 AND Term Units != 0; Institutional Data)",
